/**
 * @file gt_serial_var_artistic.h
 * @author Yang
 * @brief
 * @version 0.1
 * @date 2024-09-30 15:51:41
 * @copyright Copyright (c) 2014-2024, Company Genitop. Co., Ltd.
 */
#ifndef _GT_SERIAL_VAR_ARTISTIC_H_
#define _GT_SERIAL_VAR_ARTISTIC_H_
...
#endif //!_GT_SERIAL_VAR_ARTISTIC_H_
