/**
 * @file gt_serial_var_progress_bar.h
 * @author Yang
 * @brief
 * @version 0.1
 * @date 2024-10-29 10:43:41
 * @copyright Copyright (c) 2014-2024, Company Genitop. Co., Ltd.
 */
#ifndef _GT_SERIAL_VAR_PROGRESS_BAR_H_
#define _GT_SERIAL_VAR_PROGRESS_BAR_H_
...
#endif //!_GT_SERIAL_VAR_PROGRESS_BAR_H_
